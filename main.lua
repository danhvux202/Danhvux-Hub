...
return
-- [[ Danhvux Test - Blox Fruits Full Script ]]
-- @Danhvux Test

-- 1. Màn hình Loading với Logo
...
ImageLabel.Image = "rbxassetid://132855999043583" -- Logo của bạn
...
local Window = Fluent:CreateWindow({
    ...
    Icon = "rbxassetid://132855999043583"
})
...
-- [ TAB MAIN ]
local AutoFarmToggle = Tabs.Main:AddToggle("AutoFarm", {Title = "Auto Farm Level", Default = false})
AutoFarmToggle:OnChanged(function()
    _G.AutoFarm = Fluent.Options.AutoFarm.Value
end)

-- 3. Logic gốc từ SourceBF.lua.txt (Phần quan trọng)
